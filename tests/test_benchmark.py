...
def test_benchmark_report_formats_single_call_case_metrics_with_single_call_label() -> None:
    execution = BenchmarkExecution(
        result=BenchmarkResult(
            case_id="q001",
            answer="Respuesta",
    ...
    assert "     Single Call | input=120" in formatted
    assert "     Answer   | input=120" not in formatted